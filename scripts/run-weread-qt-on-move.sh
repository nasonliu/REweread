...
copy_if_size_differs "$ROOT_DIR/downloads/fonts/stage/source-han-sans-sc/source-han-sans-sc.otf" "$REMOTE_DIR/fonts/source-han-sans-sc.otf"
copy_if_size_differs "$ROOT_DIR/downloads/fonts/stage/source-han-serif-sc/source-han-serif-sc.otf" "$REMOTE_DIR/fonts/source-han-serif-sc.otf"
copy_if_size_differs "$ROOT_DIR/downloads/fonts/stage/chill-kai/chill-kai.ttf" "$REMOTE_DIR/fonts/chill-kai.ttf"
copy_if_size_differs "$ROOT_DIR/downloads/fonts/stage/chill-huosong/chill-huosong.otf" "$REMOTE_DIR/fonts/chill-huosong.otf"
