...
const upgrade = read('docs/agent-upgrade-v2.0.md');

assert(readme.includes('`2.0.0`') && readme.includes('agent-upgrade-v2.0.md'), 'README must route agents into the 2.0 upgrade flow');
...
console.log('2.0 user and Agent guides ok');
